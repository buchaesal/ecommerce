...
public class InicisFactory {
    ...
    public static MultiValueMap<String, String> inicisVirtualAccountRequest(Order order, PaymentMethod paymentMethod) {
        ...
        result.add("goodName", order.getGoodsNm());
        result.add("buyerName", order.getOrdNm());
    ...
    public static MultiValueMap<String, String> allRefundVirtualAccount(CancelRequest request, OriginalOrder originalOrder){
    ...
    public static MultiValueMap<String, String> partialRefundVirtualAccount(CancelRequest request, OriginalOrder originalOrder){
    ...
    private static MultiValueMap<String, String> commonRefundVirtualAccount(CancelRequest request, OriginalOrder originalOrder){
